<template>
  ...
  <div class="image-container">
    <img src="/public/imgs/26887594_m.jpg" class="cropped-image" />
  </div>
  <div id="faq" class="faq-body">
    <div class="faq-header">
      <h3 class="faq-title">FAQ's 常見問題</h3>
      ...
      <div>
        <details open>
          ...
          <p class="faq-content">
            ...
            quod debitis ducimus iste soluta rerum ipsa consequuntur minus quae.
            Ea minus ex corporis, pariatur quia rerum sequi iusto odit enim
            expedita fugiat, assumenda molestiae earum iste blanditiis, ipsum
            ratione.
          </p>
        </details>
      </div>
      <div>
        <details>
          ...
          <p class="faq-content">
            ...
            eius inventore quidem. Dignissimos, facere quae. Rem quas a laborum
            est officia pariatur voluptatum iusto perferendis aut labore fugit
            magni inventore nulla architecto, velit, facilis itaque.
          </p>
        </details>
      </div>
      <div>
      ...
      <div>
        <details>
          ...
          <p class="faq-content">
            ...
            quos quam asperiores enim sequi nihil? Iure blanditiis autem in
            ratione rerum, sequi cupiditate eos nemo iusto unde eaque voluptatum
            alias, porro aliquid sunt. Nesciunt veritatis, ex esse tempora
            laudantium officiis? Quas corrupti a aut sed quaerat, ipsa incidunt
            tempora velit dolor distinctio repellat tenetur illum consectetur
            quos veniam eius provident earum doloremque commodi! Minus amet,
            obcaecati rem, modi accusantium ad, deleniti possimus incidunt
            laudantium vitae iusto laborum culpa! Similique, repellat.
          </p>
        </details>
      </div>
      <div>
...
.cropped-image {
  width: 50%;
  height: auto; /* 让图像的高度随比例缩放 */
  object-fit: cover;
  object-position: center top; /* 调整图像的显示位置到上方居中 */
}
