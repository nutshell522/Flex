  ...
  <div class="container">
    ...
    <div class="mb-3">
      <p>
        ...
        >，並願意遵守以下所有條款與約定。在此，本人郑重承諾遵守本切結書所規定的所有規定與要求，並將全力配合活動主辦方的運作。
        <br />

        1. 健康安全：本人保證自身身體狀況良好，並無任何潛在的傳染病或感染風險。若本人在活動期間出現任何症狀或發現任何健康風險，將立即通報活動主辦單位。
        <br />

        2. 活動規定：本人將遵守活動主辦單位所制定的一切規定和指導方針，包括但不限於活動時間、地點、行程安排和參與活動的規範。
        <br />
        3. 財物損失：本人了解在活動期間所攜帶的個人財物和物品由本人負責保管，若有任何損失或損壞，活動主辦單位將不負擔任何賠償責任。
        <br />
        4. 活動安全：本人明白參加活動可能存在某些風險，包括但不限於身體受傷、財物損失等，並願意自行承擔相關風險。本人同意在活動期間嚴格遵守活動主辦單位的安全指示，確保自身和他人的安全。
      </p>
    </div>
