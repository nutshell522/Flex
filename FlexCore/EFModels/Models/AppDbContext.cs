...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => e.ActivityStatusDescription, "UQ__Activity__732635ECD89B4633")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.BranchName, "UQ__Branches__3903DB0346A4DEBA")
                    .IsUnique();

                entity.HasIndex(e => e.BranchAddress, "UQ__Branches__F50DE17A3F014258")
                    .IsUnique();
            ...
            modelBuilder.Entity<CustomizedOrder>(entity =>
            {
                entity.HasKey(e => e.Customized_Id)
                    .HasName("PK__Customiz__AFADABDDE265BB9F");
            ...
            modelBuilder.Entity<Customized_material>(entity =>
            {
                entity.HasKey(e => e.Shoesmaterial_Id)
                    .HasName("PK__Customiz__06EFE12DC16198ED");
            ...
            modelBuilder.Entity<EcpayOrder>(entity =>
            {
                entity.HasKey(e => e.MerchantTradeNo)
                    .HasName("PK__EcpayOrd__D6311910A44D75D8");
            ...
            modelBuilder.Entity<MembershipLevel>(entity =>
            {
                ...
                entity.HasMany(d => d.fk_Privileges)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("fk_LevelId", "fk_PrivilegeId").HasName("PK__Membersh__580C8EAAA5233F95");
            ...
            modelBuilder.Entity<OneToOneReservation>(entity =>
            {
                entity.HasKey(e => e.ReservationId)
                    .HasName("PK__OneToOne__B7EE5F242F853BE7");
            ...
            {
                entity.HasKey(e => e.ReservationId)
                    .HasName("PK__Reservat__B7EE5F243264BACF");

                entity.HasIndex(e => e.ReservationStatusDescription, "UQ__Reservat__ADF40EA617B4EB6B")
                    .IsUnique();
            ...
            modelBuilder.Entity<ShoesColorCategory>(entity =>
            {
                entity.HasKey(e => e.ShoesColorId)
                    .HasName("PK__ShoesCol__BB1469D43E7087D3");
            ...
            modelBuilder.Entity<ShoesPicture>(entity =>
            {
                entity.HasKey(e => e.ShoesPicture_Id)
                    .HasName("PK__ShoesPic__DF35EBA45232636B");
            ...
            modelBuilder.Entity<ShoesSize>(entity =>
            {
                entity.HasKey(e => e.SizeId)
                    .HasName("PK__ShoesSiz__83BD097A4D422810");
            ...
            modelBuilder.Entity<SpeakerField>(entity =>
            {
                entity.HasKey(e => e.FieldId)
                    .HasName("PK__SpeakerF__C8B6FF07F66DB05E");
            ...
            {
                entity.HasIndex(e => e.SupplierCompanyNumber, "UQ__Supplier__AE8E9B4179C82B9D")
                    .IsUnique();
